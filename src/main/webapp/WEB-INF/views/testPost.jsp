		...
		<div class="main-agileinfo">	
			<div class="agileits-top">
				<form action="register" method="post">
					<input class="text" type="email" name="username" placeholder="Username@example.com" required="">
					<input class="text email" type="text" name="name" placeholder="Your name" required="">
